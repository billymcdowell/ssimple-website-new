...
const events: EventItem[] = [
  ...
  },
  {
    ...
    title: 'PostTrade 360°',
    description:
      'Post‑trade industry conference on operational resilience, data standardisation, and how interoperable SSI infrastructure can simplify complex settlement chains.',
  ...
  },
  {
    ...
    description:
      'Industry awards recognising firms and individuals driving innovation across the securities finance ecosystem.',
  ...
  },
  {
    ...
    description:
      'Flagship operations event on settlement automation, operational resilience, and how modern SSI infrastructure can support new expectations.',
      ...
      <div className="max-w-5xl mx-auto">
        <header className="mb-10">
          ...
          <h1 className="text-3xl sm:text-4xl lg:text-5xl font-semibold text-obsidian dark:text-white mb-4">
            Where we discuss the future of settlement.
          </h1>
          <p className="text-base sm:text-lg text-slate-600 dark:text-slate-300 max-w-3xl">
            Ssimple participates in conferences, webinars, and awards focused on T+1 readiness, SSI automation, and
            the modernisation of post‑trade infrastructure. Explore recent and upcoming engagements below.
          </p>
        </header>
